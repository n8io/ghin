...
class GhinClient {
  ...
  public golfers: {
    getOne: (
      ghinNumber: number
    ) => Promise<GolferSearchResponse["golfers"][number] | undefined>;
    getScores: (
      ghinNumber: number,
      request?: ScoresRequest
    ) => Promise<ScoresResponse>;
    search: (
      request: GolferSearchRequest
    ) => Promise<GolferSearchResponse["golfers"]>;
  };
  ...
  constructor(config: ClientConfig) {
    ...
    this.handicaps = {
      ...
      getCoursePlayerHandicaps:
        this.handicapsGetCoursePlayerHandicaps.bind(this),
    };
  ...
  private async handicapsGetOne(
    ghin: number
  ): Promise<HandicapResponse["golfer"]> {
